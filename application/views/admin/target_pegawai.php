...
<html>
  ...
  $database11="id_target_pegawai";
  $database21="id_user";
  $database31="id_kategori";
  $database41="fokus";
  $database51="all";
  $database61="bulan_target";
  $database71="tahun_target";
//--------------------------------------------
  $table_11='table_id1';
  $add1='add_book1()';
  $save_a1='add1';
  ...
  <div class="container">
    ...
    <h3>Data Target Pegawai</h3>
    <br />
    <button class="btn btn-primary" onclick="<?php	echo	$add1;?>"> Add Target Pegawai</button>
    <br />
    <br />
    <table id="<?php	echo	$table_11;?>" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
				<?php
				$no=1;
				foreach($target_pegawai as $book){?>
				     <tr>
				         <td><?php echo $no++;?></td>
				         
								 <td><?php echo $book->username;?></td>
								<td><?php echo $book->kategori;?></td>
								<td><?php echo $book->fokus;?></td>
								<td><?php echo $book->all;?></td>
								<td><?php echo $book->bulan_target;?></td>
								<td><?php echo $book->tahun_target;?></td>
							
								<td>
									<button class="btn btn-warning" onclick="<?php	echo	$edit_11;?>(<?php echo $book->id_target_pegawai;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="<?php	echo	$delete_11;?>(<?php echo $book->id_target_pegawai;?>)"><i class="glyphicon glyphicon-remove"></i></button>
  ...
  $(document).ready( function () {
    ...
    function <?php	echo	$edit_21;?>
    {
      ...
      $.ajax({
        url : "<?php echo site_url('index.php/admin/target_pegawai_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      {
          url = "<?php echo site_url('index.php/admin/target_pegawai_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/admin/target_pegawai_update')?>";
      }
    ...
    function <?php	echo	$delete_21;?>
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('index.php/admin/target_pegawai_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Form Target Pegawai</h4>
        ...
        <form action="#" id="<?php	echo	 $form1;?>" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
			  <select  name="<?php	echo$datalocal21;	?>" class="form-control ">
			  <?php
			  foreach($pegawai as $book){?>
			  <option value="<?php echo  $book->id_user ;?>" ><?php echo $book->username ;?>	</option><?php	}	?>
			</select>
			...
			<div class="form-group">
			  ...
			  <option value="<?php echo  $book->id_kategori ;?>" ><?php echo $book->kategori ;?>	</option><?php	}	?>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input   	name="<?php	echo$datalocal41;	?>" placeholder="Masukan target fokus" class="form-control" type="text">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input   	name="<?php	echo$datalocal51;	?>" placeholder="Masukan Target	AllType" class="form-control" type="text">
			...
			<div class="form-group">
              ...
              <div class="col-md-9">
			  <select  name="<?php	echo$datalocal71;	?>" class="form-control ">

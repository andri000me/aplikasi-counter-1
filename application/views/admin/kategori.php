...
//--------------------------------------------
  ...
  <div class="container">
    ...
    <h3>Data	Kategori</h3>
    <br />
    <button class="btn btn-primary" onclick="<?php	echo	$add1;?>"> Add Kategori</button>
    <br />
    <br />
				...
				foreach($kategori as $book){?>
				     <tr>
				         <td><?php echo $no++;?></td>
								...
								<td>
									<button class="btn btn-warning" onclick="<?php	echo	$edit_11;?>(<?php echo $book->id_kategori;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="<?php	echo	$delete_11;?>(<?php echo $book->id_kategori;?>)"><i class="glyphicon glyphicon-remove"></i></button>
  ...
  $(document).ready( function () {
    ...
    function <?php	echo	$edit_21;?>
    {
      ...
      $.ajax({
        url : "<?php echo site_url('index.php/admin/kategori_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      {
          url = "<?php echo site_url('index.php/admin/kategori_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/admin/kategori_update')?>";
      }
    ...
    function <?php	echo	$delete_21;?>
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('index.php/admin/kategori_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <form action="#" id="<?php	echo	 $form1;?>" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="<?php	echo$datalocal21;	?>" placeholder="Masukan	Kategori" class="form-control" type="text">
              </div>
            </div>
